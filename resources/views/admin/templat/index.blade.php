...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent ">
				<a data-toggle="collapse" href="#sub-item-1"><em class="fa fa-edit">&nbsp;</em> Master Data <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span></a>
				<ul class="children collapse" id="sub-item-1">
					<li>
						<a href="{{url('admin/buku')}}"><span class="fa fa-minus">&nbsp;</span> Buku</a>
					</li>
						<li><a href="#"><span class="fa fa-minus">&nbsp;</span> Sub Item 2</a>
					</li>
					<li>
						<a href="#"><span class="fa fa-minus">&nbsp;</span> Sub Item 3</a>
					</li>
				</ul>
			</li>
